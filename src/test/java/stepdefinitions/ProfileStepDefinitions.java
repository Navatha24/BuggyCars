...
public class ProfileStepDefinitions extends BaseFixture {
    ...
    public void changes_are_saved_with_confirmation_message(String expectedMessage) throws Throwable {
        assertThat(brProfilePage.getConfirmationMessage(),is(expectedMessage));
    ...
    public void hobby_is_displayed_as_by_default(String expectedMessage) throws Throwable {
        assertThat(brProfilePage.getDefaultHobbyDisplay(),is(expectedMessage));
    }
